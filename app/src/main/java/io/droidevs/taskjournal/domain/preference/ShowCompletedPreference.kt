...
interface ShowCompletedPreference {
    fun getShowCompleted(): Flow<Result<Boolean, PreferenceError>>
    suspend fun setShowCompleted(showCompleted: Boolean): Result<Unit, PreferenceError>
} 