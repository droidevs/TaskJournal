...
interface NoteDao {
    ...
    fun getAllNotesSortedByTitleAsc(offset: Int, limit: Int): Flow<List<NoteWithCategory>>

    @Query("SELECT * FROM notes WHERE is_deleted = 0 ORDER BY title DESC LIMIT :limit OFFSET :offset")
    fun getAllNotesSortedByTitleDesc(offset: Int, limit: Int): Flow<List<NoteWithCategory>>
    ...
    fun getAllNotesSortedByDateAsc(offset: Int, limit: Int): Flow<List<NoteWithCategory>>
    ...
    fun getAllNotesSortedByDateDesc(offset: Int, limit: Int): Flow<List<NoteWithCategory>>
    ...
    fun searchNotesSortedByTitleAsc(query: String, offset: Int, limit: Int): Flow<List<NoteWithCategory>>
    ...
    fun searchNotesSortedByTitleDesc(query: String, offset: Int, limit: Int): Flow<List<NoteWithCategory>>
    ...
    fun searchNotesSortedByDateAsc(query: String, offset: Int, limit: Int): Flow<List<NoteWithCategory>>
    ...
    fun getNotesByCategorySortedByTitleAsc(categoryId: Long, offset: Int, limit: Int): Flow<List<NoteWithCategory>>

    @Query("SELECT * FROM notes WHERE category_id = :categoryId AND is_deleted = 0 ORDER BY title DESC LIMIT :limit OFFSET :offset")
    fun getNotesByCategorySortedByTitleDesc(categoryId: Long, offset: Int, limit: Int): Flow<List<NoteWithCategory>>

    @Query("SELECT * FROM notes WHERE category_id = :categoryId AND is_deleted = 0 ORDER BY updated_at ASC LIMIT :limit OFFSET :offset")
    fun getNotesByCategorySortedByDateAsc(categoryId: Long, offset: Int, limit: Int): Flow<List<NoteWithCategory>>

    @Query("SELECT * FROM notes WHERE category_id = :categoryId AND is_deleted = 0 ORDER BY updated_at DESC LIMIT :limit OFFSET :offset")
    fun getNotesByCategorySortedByDateDesc(categoryId: Long, offset: Int, limit: Int): Flow<List<NoteWithCategory>>
